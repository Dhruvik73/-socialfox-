...
function Register() {
    ...
    const submit = async () => {
      if(val.password.length>=8&&val.password==val.cpassword){const url = "http://65.0.19.137:5001/user/signup";
      const reqbody = {
        method: "POST",
                ...
                <div className="card-body p-4 p-lg-5 text-black">
                  ...
                  <form>  
                    ...
                    <div className="form-outline mb-2">
                      ...
                      <input type="text" id="fname" name='fname' onChange={onchange} className="form-control form-control-lg" autoComplete='name'/>
                    </div>
                    <div className="form-outline mb-2">
                      <label className="form-label" htmlFor="lname" style={{marginRight:29+'vw'}} >Last Name</label>
                      <input type="text" id="lname" name='lname' onChange={onchange} className="form-control form-control-lg" autoComplete='name'/>
                    </div>
  
                    <div className="form-outline mb-2">
                      <label className="form-label"htmlFor="form2Example17" style={{marginRight:28+'vw'}} >Email address</label>
                      <input type="email" id="form2Example17" name='email' onChange={onchange} className="form-control form-control-lg" autoComplete='email'/>
                    </div>
  
                    <div className="form-outline mb-2">
                    <label className="form-label mr-8" style={{marginRight:30+'vw'}}  htmlFor="form2Example27">Password</label>
                      <input type="password" id="form2Example27" name='password' onChange={onchange} className="form-control form-control-lg" autoComplete='new-password'/>
                    </div>
                    <div className="form-outline mb-2">
                    <label className="form-label mr-8" style={{marginRight:26+'vw'}}  htmlFor="cpassowrd">Confirm Password</label>
                      <input type="password" id="cpassword" name='cpassword' onChange={onchange} className="form-control form-control-lg" autoComplete='new-password'/>
                    </div>
